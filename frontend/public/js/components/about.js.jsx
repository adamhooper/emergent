  ...
  render: function() {
    return (
      ...
      <div className="container">
        ...
        <p>Have a rumor we should be tracking? A source we should add to an existing story? Feedback to share? <a href=mailto:craig@craigsilverman.ca>Email us</a>.
        <p>You can also <a href=http://eepurl.com/3mb9T>sign up to our mailing list</a> for occasional updates.(We never sell or share your info.)
        
        <p>Founder/Editor: Craig Silverman</p>|<p>Lead Developer: Adam Hooper</p>|<p>Design and Interaction: <a href=http://www.normative.com>Normative</a></p>|<p>Research Assistant: Joscelyn Shawn Ganjhara Jurich</p>
        </html>
      </div>
