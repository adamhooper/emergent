  ...
  render: function() {
    return (
      ...
      <div className="container">
        ...
        <p>Emergent is a real-time rumor tracker. It's part of a research project with the <ahref=http://towcenter.org/>Tow Center for Digital Journalism</a> at Columbia University that focuses on how unverified information and rumor are reported in the media. It aims to develop and best practices for debunking misinformation. Read more about the research <a href="http://www.craigsilverman.ca/2014/09/02/researching-rumors-and-debunking-for-the-tow-center-at-columbia-university/">here</a>.</p>
